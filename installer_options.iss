...
Name: {group}\test current config; Filename: {app}\configuration_setup_utility\vendor\ffmpeg\bin\ffplay.exe; WorkingDir: {app}; Parameters: -f dshow -i video=avisynth-as-capture-source
